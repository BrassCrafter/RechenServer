 ...
 * </p>
 * <p>
 * Klasse util.network.Client
 * </p>
 * <p>
 * Objekte von Unterklassen der abstrakten Klasse util.network.Client ermoeglichen
 * Netzwerkverbindungen zu einem util.network.Server mittels TCP/IP-Protokoll. Nach
 * Verbindungsaufbau koennen Zeichenketten (Strings) zum util.network.Server gesendet und von
