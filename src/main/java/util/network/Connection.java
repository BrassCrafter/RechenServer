 ...
 * </p>
 * <p>
 * Klasse util.network.Connection
 * </p>
 * <p>
 * Objekte der Klasse util.network.Connection ermoeglichen eine Netzwerkverbindung zu einem
 * util.network.Server mittels TCP/IP-Protokoll. Nach Verbindungsaufbau koennen Zeichenketten
 * (Strings) zum util.network.Server gesendet und von diesem empfangen werden. Zur
