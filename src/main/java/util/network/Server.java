...
import util.datastructures.List;
 ...
 * </p>
 * <p>
 * Klasse util.network.Server
 * </p>
 * <p>
 * Objekte von Unterklassen der abstrakten Klasse util.network.Server ermoeglichen das
 * Anbieten von Serverdiensten, so dass Clients Verbindungen zum util.network.Server mittels
...
public abstract class Server{
  ...
  private class NewConnectionHandler extends Thread{
    ...
    public void run() {
      while (active) {
        try {
          //Warten auf Verbdinungsversuch durch util.network.Client:
          Socket clientSocket = serverSocket.accept();
          // Eingehende Nachrichten vom neu verbundenen util.network.Client werden
          ...
          /*
           * Kann keine Verbindung zum anfragenden util.network.Client aufgebaut werden,
           * geschieht nichts.
           */
        }
      }
